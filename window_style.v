...
pub fn (w WindowStyle) to_json_any() json2.Any {
	mut obj := map[string]json2.Any{}
	obj['bg_color'] = hex_color(w.bg_color)
	return obj
}

pub fn (mut w WindowStyle) from_json(a json2.Any) {
	m := a.as_map()
	w.bg_color = HexColor((m['bg_color'] or { json2.Any('') }).str()).color()
}
