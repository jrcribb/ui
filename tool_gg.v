...
pub fn intersection_rect(r1 gg.Rect, r2 gg.Rect) gg.Rect {
	...
	br_x, br_y := math.min(r1.x + r1.width, r2.x + r2.width), math.min(r1.y + r1.height, r2.y +
		r2.height)
	// intersection
...
pub fn union_rect(r1 gg.Rect, r2 gg.Rect) gg.Rect {
	...
	br_x, br_y := math.max(r1.x + r1.width, r2.x + r2.width), math.max(r1.y + r1.height, r2.y +
		r2.height)
	// intersection
	r := gg.Rect{f32(tl_x), f32(tl_y), f32(br_x - tl_x), f32(br_y - tl_y)}
	return r
